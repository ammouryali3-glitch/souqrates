          ...
          <motion.div key="playing" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="relative flex-1 flex flex-col h-full">
            <div className="absolute top-0 left-0 right-0 z-20 px-4 pt-3 bg-gradient-to-b from-black/80 via-black/40 to-transparent">
              <div className="flex items-center justify-between mb-2">
                <Link href="/games"><button className="w-8 h-8 rounded-full bg-black/50 border border-cyan-500/30 flex items-center justify-center text-cyan-300"><ArrowLeft size={15} /></button></Link>
                <div className="flex flex-col items-center gap-0.5">
                  <span className="font-display font-black text-2xl text-cyan-300 leading-none drop-shadow-[0_0_10px_rgba(0,255,255,0.6)]">{scoreDisp}</span>
                  <span className="text-[9px] text-cyan-400/50 font-display uppercase tracking-widest">GOAL {ticket?.target}</span>
                </div>
              ...
              <div className="flex flex-col gap-1 pb-3">
                <div className="flex items-center justify-between px-0.5"><span className="text-[9px] tracking-widest text-cyan-300/60 font-display uppercase">Score</span><span className="text-[10px] font-mono font-bold text-white/70">{scoreDisp} / {ticket?.target}</span></div>
