        ...
        {phase === "playing" && (
          <motion.div key="playing" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="relative flex-1 flex flex-col h-full">
            <div className="absolute top-0 left-0 right-0 h-1 bg-white/10 z-10">
              <div ref={timerBarRef} className="h-full bg-gradient-to-r from-emerald-400 to-green-400 transition-none" style={{ width: "100%" }} />
            </div>
            <div className="absolute top-3 right-3 z-10 bg-black/40 rounded-full px-3 py-1">
              <span className="font-display text-xs text-emerald-300">{timeLeft}s</span>
            </div>
