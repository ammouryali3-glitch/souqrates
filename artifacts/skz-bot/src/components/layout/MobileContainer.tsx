        ...
        <header className="flex items-center justify-between px-5 pt-6 pb-2 relative z-10">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-primary to-accent flex items-center justify-center shadow-[0_0_15px_rgba(212,175,55,0.4)]">
              <span className="font-display font-bold text-primary-foreground text-sm tracking-tighter">SK</span>
            </div>
            <h1 className="font-display font-black text-xl tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-white to-white/70">SKZ BOT</h1>
          </div>
